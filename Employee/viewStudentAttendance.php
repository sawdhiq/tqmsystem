       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">View Data Entry</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">View Data Entry</li>
            </ol>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <?php
                        $qry= "SELECT * FROM tblstudents where classId = '$_SESSION[classId]' and classArmId = '$_SESSION[classArmId]' ORDER BY Id ASC";
                        $result = $conn->query($qry);
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="DateCreated" class="form-control mb-3">';
                          echo'<option value="">--Select Service Area--</option>';
                          while ($rows = $result->fetch_assoc()){
                          echo'<option value="'.$rows['dateCreated'].'" >'.$rows['classId'].' '.$rows['ClassArmId'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">View Data Entry</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Data Entry</h6>
                </div>
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        $query = "SELECT tblstudents.Id,tblservicearea.serviceArea,
                        tblservicearea_arms.serviceareaArms,
                        tblstudents.period,tblstudents.electricity,tblstudents.nurseduty,tblstudents.dateCreated
                        FROM tblstudents
                        ...
                        where tblstudents.serviceArea = '$serviceArea' and tblstudents.classId = '$_SESSION[classId]' and tblstudents.classArmId = '$_SESSION[classArmId]'";
