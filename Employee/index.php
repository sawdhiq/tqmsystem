...
include '../Includes/session.php';
    ...
    $query = "SELECT tblservicearea.serviceArea,tblservicearea_arms.serviceareaArms 
    FROM tblclassteacher
    INNER JOIN tblservicearea ON tblservicearea.Id = tblclassteacher.classId
    INNER JOIN tblservicearea_arms ON tblservicearea_arms.Id = tblclassteacher.classArmId
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <!-- <h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (<?php echo $rrw['serviceArea'].' - '.$rrw['serviceareaArms'];?>)</h1> -->
            <ol class="breadcrumb">
...
?>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Data Entry</div>
            ...
            <!-- Class Card -->
             <?php 
$query1=mysqli_query($conn,"SELECT * from tblservicearea");                       
...
?>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Service Area</div>
            ...
            <!-- Class Arm Card -->
             <?php 
$query1=mysqli_query($conn,"SELECT * from tblservicearea_arms");                       
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Service Area Arms</div>
